...
//         if (caracteresEspeciais.length >= 1 && numeros.length >= 2 && maiusculas.length >= 1) {
//             senhaValida = true
//         } else {
//             if (caracteresEspeciais.length < 1) {
//                 this.dispararErro(this.campoSenha, '* Insira ao menos um caracteres especiais.')
//             } 
...
//                 this.dispararErro(this.campoSenha, '* Insira ao menos um caracteres maiúsculos.')
//             }
//         }
